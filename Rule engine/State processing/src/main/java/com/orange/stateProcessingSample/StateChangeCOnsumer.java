package com.orange.stateProcessingSample;
...
/**
 * Application connects to LO and consumes state change events.
 *
 * 
 */
...
public class StateChangeConsumer {
	...
	// Connection parameters
		...
		public static String USERNAME  = "payload+bridge";							   // The option to subscribe in bridge mode
		...
		public static String TOPIC="router/~event/v1/data/samples/eventprocessing/stateChanged";	// topic to subscribe to
